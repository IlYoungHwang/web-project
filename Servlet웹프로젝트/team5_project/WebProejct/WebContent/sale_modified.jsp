     ...
     <% if(member != null){%>
      ...
      <div class="row">
            ...
            <div class="form-group">
            	...
            	<img src="#" id="blah"  width="260" height="200"><br><br>
            ...
            <div class="form-group">
              ...
              <input type="text" name="salename" class="form-control" value="" placeholder="물품 이름"required autofocus>
            </div>
            <div class="form-group">
              <label for="Option">물품옵션</label>
              <input type="text" name="saleoption" class="form-control" value="" placeholder="물품 옵션" required autofocus>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="saleprice" class="form-control" value="" placeholder="가격" required autofocus>
            </div>
