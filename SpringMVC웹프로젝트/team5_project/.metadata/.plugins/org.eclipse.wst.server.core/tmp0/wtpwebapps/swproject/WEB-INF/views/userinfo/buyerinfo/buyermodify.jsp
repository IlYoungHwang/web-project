      ...
      <div class="jumbotron" style="margin-top:20px">
		<form method="post">
			<div class="form-group text-left">
				...
				<input type="email" class="form-control" name="email" value="${userVO.email}"  readonly placeholder="이메일을 입력하세요" >
			</div>
			<div class="form-group text-left">
			...
			<div class="form-group text-left">
				...
				<input type="text" class="form-control" name="address" value="${userVO.address}" placeholder="암호">
			</div>
