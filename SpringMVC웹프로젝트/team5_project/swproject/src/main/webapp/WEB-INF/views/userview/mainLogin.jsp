  	   ...
  	   <div class="jumbotron">
  	   		<div class="row context">
  				<div class="col-xs-6 col-md-6">
    				<a href="buyerLogin" class="thumbnail"><img src="/resources/dist/img/supporter.png" class="img-rounded">구매자 로그인</a>
    				
    			</div>
    			
    			<div class="col-xs-6 col-md-6">
    				<a href="sellerLogin" class="thumbnail"><img src="/resources/dist/img/seller.png" class="img-rounded">판매자 로그인</a>
    			</div>
    		</div>
  	   </div>
    </div>
