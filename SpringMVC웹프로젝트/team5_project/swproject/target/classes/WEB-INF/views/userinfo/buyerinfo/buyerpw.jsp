...
<head>
 ...
 <script>
 	...
 	function myFunction() {
 		...
 		var pw1 = $('#password3').val();
 		var pw2 = $('#passwd').val();
	    document.getElementById("demo").innerHTML = "You wrote: " + pw1;
	...
	$(document).ready(function() {
		...
		$(".btn-primary").on("click", function() {
			self.location = "/userinfo/buyerinfo/profile?no=${login.no}";
		});
      ...
      <div class="jumbotron" style="margin-top:20px">
		<form method="post">
			<div class="form-group text-left">
				...
				<input type="password" class="form-control" id="password3" name="password3" oninput="myFunction()"  placeholder="변경할 비밀번호를 입력하세요" >
			</div>
			<div id="error" class="form-group text-left">
				...
				<input type="hidden" class="form-control" name="no" value="${login.no}">
